...
| [内部演进归纳（2.0.2→2.1.0）](../../docs/history/internal-evolution-2.0.2-to-2.1.0.md) | 内部测试期版本线与历史归档索引 | **P1** |
...
| [离线→在线升级指南](./offline-online-upgrade-guide.md) | 离线版升级在线增强版的收口路径（v2.1.0 新增） | **P1** |
...
- **"并行 / Team API / 写入隔离"** → [`../05-ops/multi-agent-horizontal-sync.md`](../05-ops/multi-agent-horizontal-sync.md)
